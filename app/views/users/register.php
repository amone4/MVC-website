	...
	<div class="row">
		<div class="col-10 offset-1 col-md-6 offset-md-3 card">
			...
			<form action="<?php echo URLROOT; ?>/users/register" method="post" class="col-sm-10 offset-sm-1 card-body small">
				...
				<div class="field">
					<label for="email">Email</label><input required type="email" class="form-control" name="email" id="email"><br>
				</div>
				<div class="field">
					<label for="phone">Phone Number</label><input required type="number" max="9999999999" min="1000000000" class="form-control" name="phone" id="phone"><br>
				</div>
				<div class="field">
					<label for="password">Password</label><input required type="password" class="form-control" name="password" id="password"><br>
				</div>
				<div class="field">
					<label for="confirm">Confirm Password</label><input required type="password" class="form-control" name="confirm" id="confirm"><br>
				</div>
